...
declare function appendLogRow(rowArray: (string | number | boolean | object | Date)[], sheetName: string, maxRows: number): void;
declare function reportError(message: string, operationName: string, err: Error, optContext: object | string): void;
declare function safeGetUserEmail(): string;
