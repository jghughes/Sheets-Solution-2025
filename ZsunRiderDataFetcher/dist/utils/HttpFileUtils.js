 ...
 */
function fetchTextFileFromUrl(url, fetchImpl = UrlFetchApp.fetch) {
    ...
    for (let attempt = 1; attempt <= maxRetries; attempt++) {
        try {
            const resp = fetchImpl(url, { muteHttpExceptions: true, timeout: timeoutMs });
...
//# sourceMappingURL=HttpFileUtils.js.map